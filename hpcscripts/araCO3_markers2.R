...
mcmc_arabidposis_co3_markers2 <- tagmMcmcTrain(object = arabidposis_co3, fcol = "markers2",
                                      numIter = 15000, burnin = 10000, thin = 10, numChains = 4)

setwd("/home/omc25/rds/hpc-work")
saveRDS(mcmc_arabidposis_co3_markers2, file = "mcmc_arabidposis_co3_markers2.rds")